...
RegisterNetEvent('kg-scoreboard:client:SetActivityBusy', function(activity, busy)
...
if Config.Toggle then
    RegisterCommand('scoreboard', function()
        if not scoreboardOpen then
            KGCore.Functions.TriggerCallback('kg-scoreboard:server:GetScoreboardData', function(players, cops, playerList)
